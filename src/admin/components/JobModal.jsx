...
const JobModal = ({ onClose }) => {
  const jobApi = `${import.meta.env.VITE_API_URL}/admin/jobs`;
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
      <div className="bg-background-dark p-6 rounded-lg w-[50%] max-h-[90vh] overflow-y-auto">
        <h2 className="text-xl font-bold mb-4">Add a New Job Posting</h2>
        <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-4">
          {[
            // { label: "Code", name: "code", type: "text" },
            { label: "Title", name: "title", type: "text" },
            { label: "Status", name: "status", type: "text" },
            // { label: "Icon (Font Awesome)", name: "icon", type: "text" },
